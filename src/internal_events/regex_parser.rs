...
impl InternalEvent for RegexParserFailedMatch<'_> {
    ...
    fn emit_metrics(&self) {
        counter!("processing_errors_total", 1, "error_type" => ErrorTypes::MatchFailed.to_str());
    }
}
...
impl InternalEvent for RegexParserMissingField<'_> {
    ...
    fn emit_metrics(&self) {
        counter!("processing_errors_total", 1, "error_type" => ErrorTypes::FieldMissing.to_str());
    }
}
...
impl<'a> InternalEvent for RegexParserTargetExists<'a> {
    ...
    fn emit_metrics(&self) {
        counter!("processing_errors_total", 1, "error_type" => ErrorTypes::TargetFieldExists.to_str());
    }
}
...
impl<'a> InternalEvent for RegexParserConversionFailed<'a> {
    ...
    fn emit_metrics(&self) {
        counter!("processing_errors_total", 1, "error_type" => ErrorTypes::TypeConversionFailed.to_str());
    }
}
